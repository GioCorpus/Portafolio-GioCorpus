    ...
    <section id="projects" className="px-4 sm:px-6 lg:px-8 py-20 sm:py-28">
      <div className="mx-auto max-w-7xl">
        <div className="mb-12 max-w-3xl">
          <p className="mb-3 font-mono text-xs uppercase tracking-[0.3em] text-accent-cyan">02 / Projects</p>
          ...
          <p className="mt-4 leading-7 text-dark-400">
            A selection of systems engineering and quantum computing projects demonstrating end-to-end development capabilities.
          </p>
        </div>
